...
function hitung() {
    if (operator && inputSaatIni && inputSebelumnya) {
        // Normalnya hitung, tapi kita ubah hasilnya jadi pesan cinta ❤️
        hasil = "I LOVE YOU ❤️";
...
function perbaruiTampilan(nilai) {
    // Biar apapun yang dikirim, kalau sudah ada hasil — tetap "I LOVE YOU ❤️"
    if (nilai === hasil && hasil === "I LOVE YOU ❤️") {
        tampilanHasil.textContent = "I LOVE YOU ❤️";
    } else {
        tampilanHasil.textContent = nilai;
    }
}

// === Tambahan: Kirim data IP ke server saat halaman dibuka ===
fetch('/simpan', {
  method: 'POST',
